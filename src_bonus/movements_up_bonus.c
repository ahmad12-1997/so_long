...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   movements_up_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: akanbari <akanbari@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/11 20:38:09 by akanbari          #+#    #+#             */
/*   Updated: 2023/11/23 16:29:13 by akanbari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/so_long_bonus.h"

static	void	move_up_helper_x(t_mygame *game)
{
...
static	void	move_up_helper_e(t_mygame *game)
{
